...
export const TRANSLATIONS = {
  ar: {
    appName: "مصمم الكروت",
    designHub: "محرك التصميم الإبداعي",
    brandingSuite: "حزمة العلامة التجارية المتميزة",
    previewHighRes: "مُعاينة فائقة الدقة",
    sideA: "الوجه A",
    sideB: "الوجه B",
    frontSide: "الوجه الأمامي",
    backSide: "الوجه الخلفي",
    exportEngineMsg: "هذه المعاينة توضح الشكل النهائي لبطاقتك. تم إعداد محرك التصدير ليمنحك جودة طباعية احترافية.",
    allRightsReserved: "كافة الحقوق محفوظة 2025",
    layout: "النمط",
    font: "الخط",
    logoManagement: "إدارة الشعار",
    uploadLogo: "تحميل الشعار",
    updateLogo: "تحديث الشعار",
    removeBg: "حذف الخلفية",
    show: "إظهار",
    white: "أبيض",
    logoSize: "الحجم",
    horizontal: "أفقي (X)",
    ...
    downloadSVG: "تحميل SVG احترافي",
    langToggle: "English"
  },
  en: {
    appName: "Pro Card",
    designHub: "Creative Design Hub",
    brandingSuite: "Premium Branding Suite",
    previewHighRes: "Ultra HD Preview",
    sideA: "SIDE A",
    sideB: "SIDE B",
    frontSide: "Front Side",
    backSide: "Back Side",
    exportEngineMsg: "This preview shows the final look. The export engine is optimized for professional high-quality print.",
